import pandas as pd
import numpy as np
from fraud_detect.file_operations import file_methods
from fraud_detect.data_preprocessing import preprocessing
from fraud_detect.data_ingestion import data_loader_prediction
from fraud_detect.application_logging import logger
from fraud_detect.Prediction_Raw_Data_Validation.predictionDataValidation import Prediction_Data_validation


class prediction:

    def __init__(self,path):
        self.file_object = open("logs/Prediction_Logs/Prediction_Log.txt", 'a+')
    ...
    def predictionFromModel(self):
        ...
        try:
            ...
            data= data.reindex(columns=kmeans.feature_names_in_)
            # print(data)
            ...
            for i in clusters:
                ...
                cluster_data= cluster_data.reindex(columns=model.feature_names_in_)
