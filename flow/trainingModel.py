...
from fraud_detect.data_ingestion import data_loader
from fraud_detect.data_preprocessing import preprocessing
from fraud_detect.data_preprocessing import clustering
from fraud_detect.best_model_finder import tuner
...
class trainModel:
    ...
    def __init__(self):
        ...
        self.file_object = open("logs/Training_Logs/ModelTrainingLog.txt", 'a+')
