...
class dBOperation:
    ...
    def __init__(self):
        self.path = 'database/Prediction_Database/'
    ...
    def dataBaseConnection(self,DatabaseName):
        ...
        try:
            ...
            file = open("logs/Prediction_Logs/DataBaseConnectionLog.txt", 'a+')
    ...
    def createTableDb(self,DatabaseName,column_names):
        ...
        try:
            ...
            file = open("logs/Prediction_Logs/DbTableCreateLog.txt", 'a+')
    ...
    def insertIntoTableGoodData(self,Database):
        ...
        log_file = open("logs/Prediction_Logs/DbInsertLog.txt", 'a+')
    ...
    def selectingDatafromtableintocsv(self,Database):
        ...
        log_file = open("logs/Prediction_Logs/ExportToCsv.txt", 'a+')
        try:
            conn = self.dataBaseConnection(Database)
